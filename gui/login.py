...
def show_login_window():
    ...
    outer_frame = ctk.CTkFrame(root, width=550, height=570, corner_radius=10, fg_color="#E50914")
...
# This ensures the login window only launches when this file is run directly
