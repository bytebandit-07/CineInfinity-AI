...
select5=ctk.CTkCheckBox(root,text="Adventure 🗺️",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select5))
select5.grid(row=5,column=0,padx=20,pady=12,sticky="w")

select6=ctk.CTkCheckBox(root,text="Animation 🎨",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select6))
select6.grid(row=6,column=0,padx=20,pady=12,sticky="w")

select7=ctk.CTkCheckBox(root,text="Children 🧒",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select7))
select7.grid(row=7,column=0,padx=20,pady=12,sticky="w")

select8=ctk.CTkCheckBox(root,text="Crime 🕵️",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select8))
select8.grid(row=8,column=0,padx=20,pady=12,sticky="w")

select9=ctk.CTkCheckBox(root,text="Documentary 📚",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select9))
select9.grid(row=9,column=0,padx=20,pady=12,sticky="w")

select10=ctk.CTkCheckBox(root,text="Drama 🎬",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select10))
select10.grid(row=10,column=0,padx=20,pady=12,sticky="w")

select11=ctk.CTkCheckBox(root,text="Fantasy 🧚",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select11))
select11.grid(row=1,column=0,padx=350,pady=12,sticky ="W")

select12=ctk.CTkCheckBox(root,text="Film-Noir 🌑",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select12))
select12.grid(row=2,column=0,padx=350,pady=12,sticky ="W")

select13=ctk.CTkCheckBox(root,text="IMAX 🎥",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select13))
select13.grid(row=3,column=0,padx=350,pady=12,sticky ="W")

select14=ctk.CTkCheckBox(root,text="Musical 🎵",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select14))
select14.grid(row=4,column=0,padx=350,pady=12,sticky ="W")

select15=ctk.CTkCheckBox(root,text="Mystery 🔎",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select15))
select15.grid(row=5,column=0,padx=350,pady=12,sticky ="W")

select16=ctk.CTkCheckBox(root,text="Sci-Fi 👽",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select16))
select16.grid(row=6,column=0,padx=350,pady=12,sticky ="W")

select17=ctk.CTkCheckBox(root,text="Thriller 😱",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select17))
select17.grid(row=7,column=0,padx=350,pady=12,sticky ="W")

select18=ctk.CTkCheckBox(root,text="War ⚔️",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select18))
select18.grid(row=8,column=0,padx=350,pady=12,sticky ="W")

select19=ctk.CTkCheckBox(root,text="Western 🤠",font=('Book Antiqua Bold',22,'bold'),command=lambda:on_checkbox_toggle(select19))
